...
class gdDaftarMasukController {
    ...
    constructor(Restangular, blockUI, $timeout) {
        ...
        this.getMasuk(this.m, this.y);
    }

    getMasuk(m, y) {
        this.block.start();
        this.Restangular.all('masuks').customGETLIST()
            .then(datas => {
                this.$timeout(() => {
                    this.datas = datas;
...
angular.module('kpmApp.gudang')
    .controller('gdDaftarMasukController', gdDaftarMasukController);